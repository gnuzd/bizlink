...
>
	<div class="flex items-center gap-8">
		<div class="flex items-center gap-4 text-[#121416]">
			...
			<h2 class="text-[#121416] text-lg font-bold leading-tight tracking-[-0.015em]">ServiceHub</h2>
		</div>
		<div class="flex items-center gap-9">
			<a class="text-[#121416] text-sm font-medium leading-normal" href="#">Explore</a>
			<a class="text-[#121416] text-sm font-medium leading-normal" href="#">For Business</a>
		</div>
	</div>
