<div class="container mx-auto space-y-10 divider-y div">
	<div class="space-y-4">
		...
		<div class="carousel carousel-center w-full rounded-box space-x-4">
			<div class="carousel-item w-full space-x-4">
				<img
					src="https://img.daisyui.com/images/stock/photo-1559703248-dcaaec9fab78.webp"
					class="object-cover aspect-video w-full rounded-box"
				/>
				<img
					src="https://img.daisyui.com/images/stock/photo-1565098772267-60af42b81ef2.webp"
					class="rounded-box object-cover aspect-video w-full"
				/>
				<img
					src="https://img.daisyui.com/images/stock/photo-1565098772267-60af42b81ef2.webp"
					class="object-cover aspect-video w-full rounded-box"
	...
	<div class="flex flex-col gap-5">
		<h3 class="text-lg font-semibold">Popular Services</h3>
